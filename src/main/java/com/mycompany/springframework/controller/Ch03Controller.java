...
public class Ch03Controller {
	...
	public String getParamData(
			...
			String param4, String param5, String param6, Model model) {
		log.info("recieveParamData() 실행");
	...
	public String requestParamAnnotationRequired(
			...
			@RequestParam(required=true) String param3, 
			@RequestParam("param4") String arg4, 
			@RequestParam("param5") String arg5, 
			Model model) {
	...
	@ResponseBody
	public String getAjaxParams(Ch03Dto dto, Model model) {
		model.addAttribute("chNum", "ch03");
