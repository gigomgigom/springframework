...
<div class="accordion" id="accordionExample">
  ...
  <div class="accordion-item">
    ...
    <div id="collapse12" class="accordion-collapse collapse ${chNum=='ch12'?'show':''}" data-bs-parent="#accordionExample">
      ...
      <ul>
         ...
         <li><a href="${pageContext.request.contextPath}/ch12/diByXml">XML 설정으로 관리빈에 의존성 주입</a></li>
         <li><a href="${pageContext.request.contextPath}/ch12/createBeanByAnnotation">어노테이션으로 괸리 빈 생성</a></li>
         <li><a href="${pageContext.request.contextPath}/ch12/diByAnnotation">어노테이션으로 관리빈에 의존성 주입</a></li>
      </ul>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="collapse13" class="accordion-collapse collapse ${chNum=='ch13'?'show':''}" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      <ul>
         <li><a href="${pageContext.request.contextPath}/ch13/writeBoardForm">게시물 작성(첨부 제외)</a></li>
      </ul>
      </div>
    </div>
  </div>
